...
# Import the data
UG_data = pd.read_csv("https://github.com/AwanyDenis/Uganda-WB-Indicator/main/data/data/API_UGA_DS2_en_csv_v2_93736.csv", skiprows=3)
...
with col[2]:
    ...
    with st.expander('About', expanded=True):
        st.write('''
            - Data: [UGA World Bank Indicator](<https://github.com/AwanyDenis/Uganda-WB-Indicator/main/data/data/API_UGA_DS2_en_csv_v2_93736.csv>).
